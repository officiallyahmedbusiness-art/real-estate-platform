...
-- Security advisor lint fixes: search_path hardening + admin-only report views
...
revoke all on public.report_units_per_day from public, anon;
revoke all on public.report_leads_per_day from public, anon;
revoke all on public.report_leads_per_listing from public, anon;
revoke all on public.report_top_developers from public, anon;
