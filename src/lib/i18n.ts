...
const ar: Dictionary = {
  "brand.name": "هارتج",
  "brand.tagline": "هارتج — تسويق عقاري",
  ...
  "submission.portal.subtitle": "قدّم وحداتك ومشروعاتك لفريق هارتج للمراجعة قبل النشر.",
  ...
  "submission.action.assign_code": "تعيين كود هارتج",
  ...
  "home.hero.badge": "تسويق هارتج العقاري الموثوق",
  "home.hero.title": "اكتشف عقارك القادم عبر هارتج للتسويق العقاري مع حملات مدروسة وفرص موثوقة.",
  ...
  "home.callback.subtitle": "اترك بياناتك وسيتواصل فريق هارتج معك خلال دقائق.",
  ...
  "home.request.subtitle": "ارسل طلبك لفريق هارتج وسنتواصل معك بسرعة.",
  ...
  "home.partners.subtitle": "شبكة مطورين موثوقة تُعرض عبر حملات هارتج.",
  "home.partners.cta": "عرض المشروعات",
  "home.ads.title": "حملات المطورين",
  "home.ads.subtitle": "إعلانات معتمدة من هارتج لمشروعات مختارة.",
  ...
  "home.proof.subtitle": "مؤشرات الأداء الرئيسية لفريق هارتج.",
  ...
  "detail.contact.subtitle": "تواصل مع فريق هارتج للتسويق العقاري لجدولة المعاينة.",
  ...
  "auth.subtitle": "تسجيل الدخول مخصص لفريق هارتج والشركاء المعتمدين.",
  ...
  "developer.create.subtitle": "املأ البيانات الأساسية وسيتم مراجعتها من فريق هارتج قبل النشر",
  ...
  "staff.subtitle": "تجهيز وحدات إعادة البيع للعرض والتسويق مع فريق هارتج.",
  ...
  "admin.review.diff.final": "نسخة هارتج",
  ...
  "about.kicker": "نبذة عن هارتج",
  "about.title": "هارتج للتسويق العقاري في مصر",
  ...
  "about.story.body": "هارتج تمزج بين فريق داخلي يدير المحتوى والبيانات، وشبكة شركاء يزوّدوننا بالمخزون، مع CRM يضمن المتابعة والقياس.",
  ...
  "about.media.caption": "أضف فيديو هارتج الرسمي من يوتيوب.",
  ...
  "careers.title": "انضم إلى فريق هارتج",
  ...
  "footer.facebook": "فيسبوك هارتج",
  "footer.linkedin": "لينكد إن هارتج",
  "footer.tiktok": "تيك توك هارتج",
  "footer.whatsapp": "واتساب هارتج",
  "footer.email": "hrtajrealestate@gmail.com",
  "footer.rights": "جميع الحقوق محفوظة",

  "home.hero.quick": "بحث سريع حسب الغرض",
  "home.why.title": "لماذا هارتج؟",
  ...
  "careers.perks.title": "لماذا تنضم إلى هارتج؟",
