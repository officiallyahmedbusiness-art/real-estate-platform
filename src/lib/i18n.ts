...
const ar: Dictionary = {
  ...
  "home.hero.ctaSecondary": "طلب مكالمة",
  ...
  "home.callback.cta": "ابدأ طلب المكالمة",
  ...
  "home.supply.title": "توريد وحدات؟",
  "home.supply.subtitle": "اختر المسار المناسب وابعث تفاصيل التوريد لفريق {{brand}}.",
  "home.supply.developer.title": "للمطورين العقاريين",
  "home.supply.developer.subtitle": "توريد مشروعات أو مراحل مع بيانات أولية للتقييم.",
  "home.supply.developer.cta": "ابدأ مع المطورين",
  "home.supply.owner.title": "للملاك/الوسطاء",
  "home.supply.owner.subtitle": "أرسل بيانات وحدتك ليتم مراجعتها قبل النشر.",
  "home.supply.owner.cta": "إرسال وحدة",
  ...
  "contact.method.call": "مكالمة هاتفية",
  "contact.method.email": "بريد إلكتروني",
  "callback.title": "طلب مكالمة",
  "callback.subtitle": "اختر وسيلة التواصل والوقت الأنسب، وسنعود إليك سريعًا.",
  "callback.form.name": "الاسم الكامل",
  "callback.form.phone": "رقم الهاتف",
  "callback.form.contact_method": "وسيلة التواصل",
  "callback.form.preferred_time": "وقت التواصل المفضل",
  "callback.form.preferred_day": "اليوم المفضل (اختياري)",
  "callback.form.reason": "سبب التواصل (اختياري)",
  "callback.form.submit": "إرسال الطلب",
  "callback.form.submitting": "جارٍ الإرسال...",
  "callback.success.title": "تم استلام طلبك",
  "callback.success.body": "هنراجع طلبك ونرد عليك في أقرب وقت.",
  "callback.success.back": "العودة للرئيسية",
  "callback.error": "تعذر إرسال الطلب. تأكد من البيانات وحاول مرة أخرى.",
  "callback.whatsapp.template": "مرحبًا {{brand}}، رقم طلب المكالمة الخاص بي هو {ref}.",
  "supply.page.title": "توريد وحدات",
  "supply.page.subtitle": "اختر المسار المناسب وأرسل بيانات التوريد لفريق {{brand}}.",
  "supply.card.developer.title": "أنا مطور عقاري",
  "supply.card.developer.subtitle": "توريد مشروعات أو مراحل للتسويق والشراكة.",
  "supply.card.developer.cta": "ابدأ مع المطورين",
  "supply.card.owner.title": "أنا مالك/وسيط وعندي وحدة",
  "supply.card.owner.subtitle": "أرسل بيانات وحدتك للمراجعة قبل النشر.",
  "supply.card.owner.cta": "إرسال وحدة",
  "supply.developer.title": "توريد للمطورين العقاريين",
  "supply.developer.subtitle": "شارك بيانات المشروعات والوحدات لنراجعها قبل النشر.",
  "supply.developer.form.company_name": "اسم الشركة",
  "supply.developer.form.contact_person_name": "اسم مسؤول التواصل",
  "supply.developer.form.role_title": "المسمى الوظيفي (اختياري)",
  "supply.developer.form.phone": "رقم الهاتف",
  "supply.developer.form.email": "البريد الإلكتروني (اختياري)",
  "supply.developer.form.contact_method": "وسيلة التواصل",
  "supply.developer.form.preferred_time": "وقت التواصل المفضل",
  "supply.developer.form.preferred_day": "اليوم المفضل (اختياري)",
  "supply.developer.form.preferred_contact_notes": "ملاحظات وقت التواصل",
  "supply.developer.form.contact_reason": "سبب التواصل (اختياري)",
  "supply.developer.form.city": "المدينة (اختياري)",
  "supply.developer.form.projects_summary": "ملخص المشروعات / الوحدات",
  "supply.developer.form.inventory_type": "نوع التوريد",
  "supply.developer.form.unit_count_estimate": "عدد الوحدات التقريبي (اختياري)",
  "supply.developer.form.brochure_url": "رابط بروشور (اختياري)",
  "supply.developer.form.attachments": "مرفقات (PDF/صور)",
  "supply.developer.form.cooperation_terms_interest": "اهتمامات التعاون (عمولة، حصرية، إلخ)",
  "supply.developer.form.submit": "إرسال طلب التوريد",
  "supply.developer.form.submitting": "جارٍ الإرسال...",
  "supply.developer.inventory.full": "مشروع كامل",
  "supply.developer.inventory.units": "وحدات متفرقة",
  "supply.developer.inventory.phase": "مرحلة",
  "supply.developer.success.title": "تم استلام طلبك — هنراجع ونرد عليك",
  "supply.developer.success.body": "شكرًا لإرسال البيانات. سيقوم فريق {{brand}} بالتواصل معك.",
  "supply.owner.title": "توريد وحدات للأفراد",
  "supply.owner.subtitle": "أرسل بيانات وحدتك وسيتم مراجعتها قبل النشر.",
  "supply.owner.form.owner_type": "نوع المورّد",
  "supply.owner.form.full_name": "الاسم الكامل",
  "supply.owner.form.phone": "رقم الهاتف",
  "supply.owner.form.email": "البريد الإلكتروني (اختياري)",
  "supply.owner.form.contact_method": "وسيلة التواصل",
  "supply.owner.form.preferred_time": "وقت التواصل المفضل",
  "supply.owner.form.preferred_day": "اليوم المفضل (اختياري)",
  "supply.owner.form.contact_reason": "سبب التواصل (اختياري)",
  "supply.owner.form.property_type": "نوع الوحدة",
  "supply.owner.form.purpose": "الغرض",
  "supply.owner.form.area": "المنطقة / الحي",
  "supply.owner.form.address_notes": "وصف العنوان (اختياري)",
  "supply.owner.form.size_m2": "المساحة (م²) اختياري",
  "supply.owner.form.rooms": "عدد الغرف (اختياري)",
  "supply.owner.form.baths": "عدد الحمامات (اختياري)",
  "supply.owner.form.price_expectation": "السعر المتوقع (اختياري)",
  "supply.owner.form.ready_to_show": "الوحدة جاهزة للمعاينة؟",
  "supply.owner.form.photos": "صور الوحدة (اختياري)",
  "supply.owner.form.media_link": "لينك صور/فيديو (اختياري)",
  "supply.owner.form.notes": "ملاحظات إضافية (اختياري)",
  "supply.owner.form.submit": "إرسال الوحدة",
  "supply.owner.form.submitting": "جارٍ الإرسال...",
  "supply.owner.type.owner": "مالك",
  "supply.owner.type.broker": "وسيط",
  "supply.owner.type.authorized": "مفوّض",
  "supply.owner.purpose.sale": "بيع",
  "supply.owner.purpose.rent": "إيجار",
  "supply.owner.ready.yes": "نعم",
  "supply.owner.ready.no": "لا",
  "supply.owner.success.title": "تم استلام طلبك — هنراجع ونرد عليك",
  "supply.owner.success.body": "تم إرسال بيانات الوحدة بنجاح.",
  "supply.success.id": "رقم الطلب",
  "supply.success.whatsapp": "فتح واتساب",
  "supply.success.back": "العودة لبوابة التوريد",
  "supply.error": "تعذر إرسال الطلب. تأكد من البيانات وحاول مرة أخرى.",
  "supply.whatsapp.template": "مرحبًا {{brand}}، رقم طلب التوريد الخاص بي هو {ref}.",
  "supply.status.new": "جديد",
  "supply.status.in_review": "قيد المراجعة",
  "supply.status.contacted": "تم التواصل",
  "supply.status.approved": "معتمد",
  "supply.status.rejected": "مرفوض",
  "admin.supply.title": "طلبات توريد الوحدات",
  "admin.supply.subtitle": "مراجعة طلبات المطورين والملاك وتحديث الحالة.",
  "admin.supply.developer.title": "طلبات المطورين",
  "admin.supply.owner.title": "طلبات الملاك/الوسطاء",
  "admin.supply.filters.status": "الحالة",
  "admin.supply.filters.from": "من تاريخ",
  "admin.supply.filters.to": "إلى تاريخ",
  "admin.supply.filters.apply": "تطبيق",
  "admin.supply.empty": "لا توجد طلبات مطابقة حاليًا.",
  "admin.supply.update": "تحديث الحالة",
  "admin.supply.internal_notes": "ملاحظات داخلية",
  "admin.supply.request_id": "رقم الطلب",
  "admin.supply.created_at": "تاريخ الطلب",
  "admin.supply.contact_method": "وسيلة التواصل",
  "admin.supply.preferred_time": "وقت التواصل",
  "admin.supply.preferred_day": "اليوم المفضل",
  "admin.supply.contact_reason": "سبب التواصل",
  "admin.supply.attachments": "المرفقات",
  "admin.supply.photos": "الصور",
  ...
  "owner.unlock.hint": "مفتاح المالك يُحدد من إعدادات Vercel Environment Variables (Production).",
  "owner.unlock.missing": "OWNER_SECRET غير مُعرّف في Production، لن ينجح أي مفتاح.",
  "owner.unlock.rate": "تم تجاوز عدد المحاولات. حاول مرة أخرى بعد قليل.",
  "owner.dashboard.title": "لوحة المالك",
  "owner.dashboard.subtitle": "متابعة حضور الفريق وساعات العمل.",
  "owner.dashboard.presence.title": "حضور فريق العمل الآن",
  "owner.dashboard.presence.subtitle": "يتم تحديث الحالات كل 30 ثانية.",
  "owner.dashboard.presence.countOnline": "متصل الآن",
  "owner.dashboard.presence.countIdle": "خامل",
  "owner.dashboard.presence.countOffline": "غير متصل",
  "owner.dashboard.table.name": "الاسم",
  "owner.dashboard.table.role": "الدور",
  "owner.dashboard.table.status": "الحالة",
  "owner.dashboard.table.started": "بداية الجلسة",
  "owner.dashboard.table.active": "المدة الحالية",
  "owner.dashboard.table.today": "ساعات اليوم",
  "owner.dashboard.table.week": "آخر 7 أيام",
  "owner.dashboard.status.online": "متصل",
  "owner.dashboard.status.idle": "خامل",
  "owner.dashboard.status.offline": "غير متصل",
...
const en: Dictionary = {
  ...
  "home.hero.ctaSecondary": "Request a call",
  ...
  "home.callback.cta": "Start call request",
  ...
  "home.supply.title": "Supply units?",
  "home.supply.subtitle": "Choose the right track and send your details to {{brand}}.",
  "home.supply.developer.title": "For developers",
  "home.supply.developer.subtitle": "Submit projects or phases for partnership review.",
  "home.supply.developer.cta": "Developer intake",
  "home.supply.owner.title": "For owners/brokers",
  "home.supply.owner.subtitle": "Share your unit details for review before publishing.",
  "home.supply.owner.cta": "Submit a unit",
  ...
  "contact.method.call": "Phone call",
  "contact.method.email": "Email",
  "callback.title": "Request a call",
  "callback.subtitle": "Choose your contact method and preferred time.",
  "callback.form.name": "Full name",
  "callback.form.phone": "Phone number",
  "callback.form.contact_method": "Contact method",
  "callback.form.preferred_time": "Preferred time",
  "callback.form.preferred_day": "Preferred day (optional)",
  "callback.form.reason": "Reason (optional)",
  "callback.form.submit": "Send request",
  "callback.form.submitting": "Submitting...",
  "callback.success.title": "Request received",
  "callback.success.body": "We will review your request and get back to you shortly.",
  "callback.success.back": "Back to home",
  "callback.error": "Unable to submit. Please check your details and try again.",
  "callback.whatsapp.template": "Hi {{brand}}, my callback request id is {ref}.",
  "supply.page.title": "Supply units",
  "supply.page.subtitle": "Choose the right path and share your inventory with {{brand}}.",
  "supply.card.developer.title": "I'm a developer",
  "supply.card.developer.subtitle": "Submit projects or phases for partnership.",
  "supply.card.developer.cta": "Developer intake",
  "supply.card.owner.title": "I'm an owner/broker",
  "supply.card.owner.subtitle": "Send your unit details for review.",
  "supply.card.owner.cta": "Submit a unit",
  "supply.developer.title": "Developer supply intake",
  "supply.developer.subtitle": "Share project and unit details for review before publishing.",
  "supply.developer.form.company_name": "Company name",
  "supply.developer.form.contact_person_name": "Contact person",
  "supply.developer.form.role_title": "Role title (optional)",
  "supply.developer.form.phone": "Phone number",
  "supply.developer.form.email": "Email (optional)",
  "supply.developer.form.contact_method": "Contact method",
  "supply.developer.form.preferred_time": "Preferred time",
  "supply.developer.form.preferred_day": "Preferred day (optional)",
  "supply.developer.form.preferred_contact_notes": "Preferred time notes",
  "supply.developer.form.contact_reason": "Reason (optional)",
  "supply.developer.form.city": "City (optional)",
  "supply.developer.form.projects_summary": "Projects / inventory summary",
  "supply.developer.form.inventory_type": "Inventory type",
  "supply.developer.form.unit_count_estimate": "Estimated unit count (optional)",
  "supply.developer.form.brochure_url": "Brochure URL (optional)",
  "supply.developer.form.attachments": "Attachments (PDF/images)",
  "supply.developer.form.cooperation_terms_interest": "Cooperation terms (commission, exclusivity, etc.)",
  "supply.developer.form.submit": "Submit supply request",
  "supply.developer.form.submitting": "Submitting...",
  "supply.developer.inventory.full": "Full project",
  "supply.developer.inventory.units": "Scattered units",
  "supply.developer.inventory.phase": "Phase",
  "supply.developer.success.title": "Request received — we will review and respond",
  "supply.developer.success.body": "Thanks for sharing your details. Our team will reach out soon.",
  "supply.owner.title": "Owner supply intake",
  "supply.owner.subtitle": "Send your unit details for review before publishing.",
  "supply.owner.form.owner_type": "Owner type",
  "supply.owner.form.full_name": "Full name",
  "supply.owner.form.phone": "Phone number",
  "supply.owner.form.email": "Email (optional)",
  "supply.owner.form.contact_method": "Contact method",
  "supply.owner.form.preferred_time": "Preferred time",
  "supply.owner.form.preferred_day": "Preferred day (optional)",
  "supply.owner.form.contact_reason": "Reason (optional)",
  "supply.owner.form.property_type": "Property type",
  "supply.owner.form.purpose": "Purpose",
  "supply.owner.form.area": "Area / neighborhood",
  "supply.owner.form.address_notes": "Address notes (optional)",
  "supply.owner.form.size_m2": "Size (m²) optional",
  "supply.owner.form.rooms": "Rooms (optional)",
  "supply.owner.form.baths": "Bathrooms (optional)",
  "supply.owner.form.price_expectation": "Price expectation (optional)",
  "supply.owner.form.ready_to_show": "Ready to show?",
  "supply.owner.form.photos": "Photos (optional)",
  "supply.owner.form.media_link": "Photo/video link (optional)",
  "supply.owner.form.notes": "Notes (optional)",
  "supply.owner.form.submit": "Submit unit",
  "supply.owner.form.submitting": "Submitting...",
  "supply.owner.type.owner": "Owner",
  "supply.owner.type.broker": "Broker",
  "supply.owner.type.authorized": "Authorized",
  "supply.owner.purpose.sale": "Sale",
  "supply.owner.purpose.rent": "Rent",
  "supply.owner.ready.yes": "Yes",
  "supply.owner.ready.no": "No",
  "supply.owner.success.title": "Request received — we will review and respond",
  "supply.owner.success.body": "Your unit details were sent successfully.",
  "supply.success.id": "Request ID",
  "supply.success.whatsapp": "Open WhatsApp",
  "supply.success.back": "Back to supply",
  "supply.error": "Unable to submit. Please check your details and try again.",
  "supply.whatsapp.template": "Hi {{brand}}, my supply request id is {ref}.",
  "supply.status.new": "New",
  "supply.status.in_review": "In review",
  "supply.status.contacted": "Contacted",
  "supply.status.approved": "Approved",
  "supply.status.rejected": "Rejected",
  "admin.supply.title": "Supply requests",
  "admin.supply.subtitle": "Review developer and owner submissions and update status.",
  "admin.supply.developer.title": "Developer requests",
  "admin.supply.owner.title": "Owner/broker requests",
  "admin.supply.filters.status": "Status",
  "admin.supply.filters.from": "From date",
  "admin.supply.filters.to": "To date",
  "admin.supply.filters.apply": "Apply",
  "admin.supply.empty": "No matching requests yet.",
  "admin.supply.update": "Update status",
  "admin.supply.internal_notes": "Internal notes",
  "admin.supply.request_id": "Request ID",
  "admin.supply.created_at": "Submitted at",
  "admin.supply.contact_method": "Contact method",
  "admin.supply.preferred_time": "Preferred time",
  "admin.supply.preferred_day": "Preferred day",
  "admin.supply.contact_reason": "Reason",
  "admin.supply.attachments": "Attachments",
  "admin.supply.photos": "Photos",
  ...
  "owner.unlock.hint": "Owner key is set via Vercel Environment Variables (Production).",
  "owner.unlock.missing": "OWNER_SECRET is not set in Production; no key will work.",
  "owner.unlock.rate": "Too many attempts. Try again in a few minutes.",
  "owner.dashboard.title": "Owner dashboard",
  "owner.dashboard.subtitle": "Track team presence and work hours.",
  "owner.dashboard.presence.title": "Live team presence",
  "owner.dashboard.presence.subtitle": "Statuses refresh every 30 seconds.",
  "owner.dashboard.presence.countOnline": "Online now",
  "owner.dashboard.presence.countIdle": "Idle",
  "owner.dashboard.presence.countOffline": "Offline",
  "owner.dashboard.table.name": "Name",
  "owner.dashboard.table.role": "Role",
  "owner.dashboard.table.status": "Status",
  "owner.dashboard.table.started": "Session start",
  "owner.dashboard.table.active": "Active duration",
  "owner.dashboard.table.today": "Today hours",
  "owner.dashboard.table.week": "Last 7 days",
  "owner.dashboard.status.online": "Online",
  "owner.dashboard.status.idle": "Idle",
  "owner.dashboard.status.offline": "Offline",
